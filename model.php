...
if ( $entry["image"] != null ) {
    ...
    $body_text = <<<BODY_TEXT
<div class="body_text"><a href="{$data_path}/{$entry['image']}" data-lightbox="image"><img class="me-3" src="{$data_path}/{$entry['image']}" style="float:left;width:150px;"></a>{$entry['body']}<div style="clear:both"></div></div>
BODY_TEXT;
}
